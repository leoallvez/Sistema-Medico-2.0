    ...
    <body>
        ...
        <form method="POST">
            <div class="cad-paciente">
                ...
                <label>Nome</label></br>
                <input type="text" name="nome" placeholder="Nome Completo do Paciente" class="input-large"required><br>
                ...
                <input type="text" name="endereco" placeholder="Endereço e Número de Residencia" class="input-large" required/><br>
                <label>CEP</label></br>
                <input type="text" name="cep" id="cep" placeholder="CEP" min="15" required><br>
                <label>Bairro</label></br>
                <input type="text" name="bairro" placeholder="Bairro" class="input-large" required/><br>
                <label>Cidade</label></br>
                <input type="text" name="cidade" placeholder="Cidade" class="input-large" required/><br>
                <label>Estado</label></br>
                <?php include "app/view/includes/view-estados.php"; ?>
                <label>Tipo de únidade de saúde</label><br>
                <?php include "app/view/includes/view-unidade-saude.php"; ?><br>
                <label>Nome da únidade de saúde</label><br>
                <input type="text" name="nome_unidade" placeholder="Unidade" class="input-large" required></br>
                <fieldset>
                    <legend>Principais Sintomas</legend>
                    <input type="checkbox" value="1" name="febre" id="febre"/>
                    <label for="febre">Febre alta com início súbito</label><br>
                    
                    <input type="checkbox" value="1" name="dor_cabeca" id="dor_cabeca"/>
                    <label for="dor_cabeca">Forte dor de cabeça</label><br>

                    <input type="checkbox" value="1" name="dor_olhos" id="dor_olhos"/>
                    <label for="dor_olhos">Dor atrás dos olhos.</label><br>

                    <input type="checkbox" value="1" name="perda_apetite" id="perda_apetite"/>
                    <label for="perda_apetite">Perda do paladar e apetite</label><br>

                    <input type="checkbox" value="1" name="mancha_pele" id="mancha_pele"/>
                    <label for="mancha_pele">Manchas ou erupções na pele</label><br>

                    <input type="checkbox" value="1" name="vomito" id="vomito"/>
                    <label for="vomito">Náuseas e vômito</label><br>

                    <input type="checkbox" value="1" name="tontura" id="tontura"/>
                    <label for="tontura">Tonturas</label><br>

                    <input type="checkbox" value="1" name="cansaco" id="cansaco"/>
                    <label for="cansaco">Extremo cansaço</label><br>

                    <input type="checkbox" value="1" name="moleza" id="moleza"/>
                    <label for="moleza"> Moleza e dor no corpo</label><br>

                    <input type="checkbox" value="1" name="dor_ossos" id="dor_ossos"/>
